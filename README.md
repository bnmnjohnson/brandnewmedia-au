...
This blog has been designed to work with the Wordpress JSON REST API using [angular-wordpress-seed](https://github.com/michaelbromley/angular-wordpress-seed)
...
The blog fetches the first four posts, and then subsequently grabs and populates the next four.
To do this, we need to change one line of code of the Wordpress JSON REST API plugin, see [here](https://github.com/nrutkowski/WP-API/commit/1fef752aeb233114cb7768a70c3c41b24e009083)
